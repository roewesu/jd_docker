      ...
      try {
        if (err) {
          ...
          if(typeof res == 'object'){
            ...
            } else if (res && typeof res == 'object' && res.errorMessage){
    ...
    $.post(taskPostUrl('/dingzhi/xiaolong/collectcard/myInfo', body), async (err, resp, data) => {
      try {
        if (err) {
          ...
          res = $.toObj(data);
          if(typeof res == 'object'){
            if(res && typeof res.data.task != 'undefined') $.task = res.data.task
            if(res && typeof res.data.drawChance != 'undefined') $.drawChance = res.data.drawChance
            if(res && typeof res.data.score != 'undefined') $.score = res.data.score
            if(res && typeof res.data.totalScore != 'undefined') $.totalScore = res.data.totalScore
          }else if(typeof res == 'object' && res.errorMessage){
            console.log(`${res.errorMessage || ''}`)
          }else{
            console.log(data)
